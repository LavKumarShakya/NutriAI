...
export const Hero = () => {
  ...
  return (
    <div id="hero" className="relative mt-[-120px] min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary/5 via-background to-secondary/10">
